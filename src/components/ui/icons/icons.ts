export const Icons = {
  groups: {
    ...
    class: "mt-1 h-8 w-8 flex-shrink-0 fill-[#5EC7A1]",
    width: 48,
    height: 48,
  ...
  tools: {
    ...
    class:
      "mt-2 h-6 w-6 flex-shrink-0 fill-neutral-700 hs-tab-active:fill-[#5EC7A1] md:h-7 md:w-7",
    width: 48,
    height: 48,
    viewBox: "0 -960 960 960",
  },
  ...
  house: {
    ...
    class:
      "h-6 w-6 flex-shrink-0 text-neutral-700 hs-tab-active:text-[#5EC7A1] md:h-7 md:w-7",
    width: 24,
    height: 24,
    viewBox: "0 0 24 24",
    fill: "none",
  ...
  arrowUp: {
    ...
    class: "h-5 w-5 flex-shrink-0 text-[#5EC7A1]",
    width: 24,
    height: 24,
    viewBox: "0 0 24 24",
    fill: "none",
    ...
    paths: [
      {
        ...
        class:
          "fill-current text-neutral-500 transition duration-300 group-hover:text-red-400",
      },
    ],
  ...
  accordionNotActive: {
    ...
    class:
      "block h-5 w-5 flex-shrink-0 text-neutral-600 group-hover:text-neutral-500 hs-accordion-active:hidden",
    width: 24,
    height: 24,
    viewBox: "0 0 24 24",
    fill: "none",
  ...
  accordionActive: {
    ...
    class:
      "hidden h-5 w-5 flex-shrink-0 text-neutral-600 group-hover:text-neutral-500 hs-accordion-active:block",
    width: 24,
    height: 24,
    viewBox: "0 0 24 24",
    fill: "none",
  ...
  xFooter: {
    ...
    class:
      "h-4 w-4 flex-shrink-0 fill-current text-neutral-700",
    viewBox: "0 0 24 24",
    fill: "currentColor",
    title: "Twitter",
  },
  ...
  quotation: {
    ...
    class:
      "absolute start-0 top-0 h-16 w-16 -translate-x-6 -translate-y-8 transform text-neutral-300",
    width: 16,
    height: 16,
    viewBox: "0 0 16 16",
    fill: "currentColor",
  ...
  question: {
    ...
    class:
      "mt-1.5 h-6 w-6 flex-shrink-0 text-neutral-600",
    viewBox: "0 0 24 24",
    fill: "none",
    strokeWidth: "1.5",
    strokeLinecap: "round",
  ...
  rocket: {
    ...
    class: "mt-1 size-8 flex-shrink-0",
    viewBox: "0 0 24 24",
    fill: "none",
    strokeWidth: "1.5",
    strokeLinecap: "round",
